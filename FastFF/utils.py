...
# %% auto 0
__all__ = ['FLATTEN_TFM', 'get_mnist_dls', 'get_cifar_dls', 'runs_sweep', 'TinyWandbCallback', 'ProbsDistrCB', 'GetGradCB',
           'smooth_avg']
...
def get_cifar_dls(bs=64, num_workers=None, tfms=noop, **kwargs):
    ...
    return data.dataloaders(path, bs=bs, valid_pct=0.2, seed=42, num_workers = num_workers, **kwargs)
